...
This document provides comprehensive documentation for all 21 hardening scripts in the toolkit. Each script is designed
to be safe for remote execution with multiple rollback mechanisms.
...
**Script:** `scripts/00-ssh-verification.sh` **Priority:** CRITICAL (0) - Runs BEFORE all hardening **Risk Level:** Low
(verification only, safe reinstall)

### Purpose

Verifies the integrity and authenticity of the OpenSSH server package before any hardening is applied. This ensures that
the SSH daemon you're about to harden is from an official source and hasn't been compromised.
...
**Script:** `scripts/01-ssh-hardening.sh` **Priority:** CRITICAL **Risk Level:** High (if misconfigured)

### Purpose

Secures SSH daemon configuration while maintaining remote access. This is the most critical script as it affects your
ability to manage the server remotely.
...
**Script:** `scripts/02-firewall-setup.sh` **Priority:** CRITICAL **Risk Level:** High (if misconfigured)
...
**Script:** `scripts/03-kernel-params.sh` **Priority:** HIGH **Risk Level:** Low
...
**Script:** `scripts/04-network-stack.sh` **Priority:** HIGH **Risk Level:** Low
...
**Script:** `scripts/05-file-permissions.sh` **Priority:** HIGH **Risk Level:** Low
...
**Script:** `scripts/06-process-limits.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/07-audit-logging.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/08-password-policy.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/09-account-lockdown.sh` **Priority:** MEDIUM **Risk Level:** Medium
...
**Script:** `scripts/10-sudo-restrictions.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/11-service-disable.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/12-tmp-hardening.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/13-core-dump-disable.sh` **Priority:** LOW **Risk Level:** Low
...
**Script:** `scripts/14-sysctl-hardening.sh` **Priority:** MEDIUM **Risk Level:** Low
...
**Script:** `scripts/15-cron-restrictions.sh` **Priority:** LOW **Risk Level:** Low
...
**Script:** `scripts/16-mount-options.sh` **Priority:** LOW **Risk Level:** Medium
...
**Script:** `scripts/17-shell-timeout.sh` **Priority:** LOW **Risk Level:** Low
...
**Script:** `scripts/18-banner-warnings.sh` **Priority:** LOW **Risk Level:** Low
...
**Script:** `scripts/19-log-retention.sh` **Priority:** LOW **Risk Level:** Low
...
**Script:** `scripts/20-integrity-baseline.sh` **Priority:** LOW **Risk Level:** Low
